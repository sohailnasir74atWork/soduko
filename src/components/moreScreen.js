...
function MoreScreen({route, navigation}) {
  ...
  return (
    <View style={[styles.moreScreenContainer, {backgroundColor: bg}]}>
      ...
      <TouchableOpacity
        style={[styles.moreButton, {color: color}]}
      ...
      <View>
        ...
        <Text style={[styles.infoText, {color: color}]}>
          If you have any ideas or suggestions to help us improve, please feel
          free to contact us. Your feedback is valuable to us, and we appreciate
